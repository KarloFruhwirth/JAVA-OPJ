...
/**
 * Implementation of IWebWorker used to print out the current time and depending
 * on the parameter name <br>
 * You did not send me your name or Your name has xy letters
 * 
